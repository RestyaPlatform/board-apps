...
|Link Nextcloud|Restyaboard has an app listed in the Nextcloud Integrations to display notifications and a search provider that searches for cards in a consistent way through Restyaboard. The app supplements it by providing the access token that is needed for accessing the Restyaboard from Nextcloud.|[Restya](http://restya.com/) |0.1.1|Paid|[Visit](http://restya.com/board/apps/r_link_nextcloud)|
