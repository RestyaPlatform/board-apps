...
|[General Data Protection Regulation](r_eu_gdpr)|About data protection and privacy for all individuals|[Restya](http://restya.com/) |0.1.1|Free|[Download](https://github.com/RestyaPlatform/board-apps/releases/download/v1/r_eu_gdpr-v0.1.1.zip)|
