...
|Grid View Configure|To hide all the card additional informations in Grid view like  Card ID, Card Name, List moved date etc.. from cards listing.|[Restya](http://restya.com/) |0.1.1|Paid|[Visit](http://restya.com/board/apps/r_gridview_configure)|
|Groups|Adds groups for handling projects.|[Restya](http://restya.com/) |0.1.2|Paid|[Visit](http://restya.com/board/apps/r_groups)|
...
|List View Configure|To hide all the card additional informations in list view like  Card ID, Card Name, List moved date etc..and changing the position of the card addition informations from cards listing.|[Restya](http://restya.com/) |0.1.1|Paid|[Visit](http://restya.com/board/apps/r_listview_configure)|
...
|SparkPost|SparkPost provides us with the real-time email metrics|[Restya](http://restya.com/) |0.1.1|Paid|[Visit](http://restya.com/board/apps/r_sparkpost)|
