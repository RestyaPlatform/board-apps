...
|Freshdesk|Freshdesk is IFTTT like workflow automation service that enables integration with over 500 other websites. This app enables connecting to Freshdesk.|[AgileShoppe](http://agileshoppe.com/) |0.1.1|Paid|[Visit](http://restya.com/board/apps/r_freshdesk)|
|Zendesk|Zendesk is IFTTT like workflow automation service that enables integration with over 500 other websites. This app enables connecting to Zendesk.|[AgileShoppe](http://agileshoppe.com/) |0.1.1|Paid|[Visit](http://restya.com/board/apps/r_zendesk)|
|Visual Studio|Visual Studio is IFTTT like workflow automation service that enables integration with over 500 other websites. This app enables connecting to Visual Studio.|[Zyndaa](http://zyndaa.com/) |0.1.1|Paid|[Visit](http://restya.com/board/apps/r_visualstudio)|
